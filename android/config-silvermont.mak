...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=../../prebuilts/ndk/current/platforms/android-24/arch-x86 -isysroot ../../prebuilts/ndk/current/platforms/android-24/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
...
DOXYGEN=doxygen
LDFLAGS=  --sysroot=../../prebuilts/ndk/current/platforms/android-24/arch-x86 -isysroot ../../prebuilts/ndk/current/platforms/android-24/arch-x86 -march=silvermont -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
